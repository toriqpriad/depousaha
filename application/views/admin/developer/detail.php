            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                           
                            <input type="hidden" class="form-control" id="dev_id" value="<?= $detail->id ?>">
                            <div class="col-md-12">
                                ...
                                <div class="form-group form-float form-group-md">
                                    ...
                                    <div class="form-line">
                                        <textarea class="form-control" id="alamat"><?= $detail->alamat ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group form-float form-group-md">
                                    <label class="form-label">Deskripsi</label>
                                    <div class="form-line">
                                        <textarea class="form-control" id="deskripsi"><?= $detail->deskripsi ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group form-float form-group-md">
                                    ...
                                    <div class="row" id='uploadarea_gallery' >
                                        <div class="col-md-6">
                                            ...
                                            if ($detail->image == "") {
                                                ...
                                                $src = base_url() . "assets/images/backend/developer/" . $detail->image;
                                            }
                                            ?>
