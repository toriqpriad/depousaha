...
<html>
    ...
    $this->load->view('admin/iklan/function');
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                           
                            <div class="col-md-12">
                                <input type="hidden" class="form-control" id="iklan_id" value="<?= $detail->id ?>">
                                    ...
                                    <div class="row" id='uploadarea_gallery' >
                                        <div class="col-md-6">
                                            ...
                                            if ($detail->image == "") {
                                                ...
                                                $src = base_url() . "assets/images/backend/iklan/" . $detail->image;
                                            }
                                            ?>
