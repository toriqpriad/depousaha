      ...
      <div class="card">
        <div class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea id="comment" class="form-control border-input"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <img id="output_logo"  class="img img-thumbnail" src="<?= BACKEND_IMAGE_FOLDER . 'noimg.png' ?>" style="width:15%;"/>
                <br><br>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="text-left">
                <a href="<?=base_url().'admin/testimoni/'?>"  class="btn btn-warning btn-fill btn-wd" onclick="">Kembali</a>
              </div>
            </div>
            <div class="col-md-6">
