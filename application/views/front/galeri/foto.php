                            ...
                            <div class="successWrapper">
                                <div class="col-sm-12 noPadding">
                                    <div class="successContent">
                                        <center>
                                            <h2>Dokumentasi properti berupa <span class="yellowTxt"> foto </span>yang dapat dinikmati.</h2></center>
                                    </div>
                                            ...
                                            <div class="gallerySingleItem">
                                                <div class="portfolio-item-content">
                                                    <div class="itemThumbnail">
                                                        ...
                                                        <img title="<?= $each['title'] ?>" style="height: 250px;" src="<?= base_url() . BACKEND_IMAGE_DIRECTORY . 'properti/' . $each['image_name']; ?>" alt="">
                                                        <div class="hoverBox">
                                                            <div class="smallIcon">
                                                                <a href="<?= base_url() . BACKEND_IMAGE_DIRECTORY . 'properti/' . $each['image_name']; ?>" data-gal="prettyPhoto[gal]" class="viewDetials p-photo" title="<?= $each['title'] ?>">View </a>
                                                            </div>
                                                            <!-- end of smallIcon -->
                                                        </div>
                                                        <!-- end of hoverBox -->
