...
<script type="text/javascript" src="<?= FRONTEND_STATIC_FILES ?>js/script.js"></script>
    <!-- Google MAp =============================== -->
    <script type="text/javascript" src='<?= FRONTEND_STATIC_FILES ?>js/jquery.mapit.js'></script>
    <script type="text/javascript" src='<?= FRONTEND_STATIC_FILES ?>js/gmap3.min.js'></script>
