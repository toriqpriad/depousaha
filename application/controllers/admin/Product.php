...
class product extends admin {
  ...
  public function update(){
    ...
    if($merchant_id != $merchant_last_id){
      $old_img = array($utamaold,$img1old,$img2old,$img3old,$img4old);
      $new_dir = "assets/images/backend/merchant/" . $merchant_id . "/product/".$id."/";
      $old_dir = "assets/images/backend/merchant/" . $merchant_last_id . "/product/".$id."/";
      foreach($old_img as $name){
        $copy = image_move($new_dir,$old_dir,$name);
      }
    }
