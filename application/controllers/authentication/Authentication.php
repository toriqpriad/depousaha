		...
		$this->load->library ( array (
			...
			public function admin_submit_login() {
				try {
					...
					$param_fail->message = "Login gagal !";
					$param_fail->data = "";
					...
					if (! empty ( $input )) {
						...
						$where1 = array ("where_column" => 'username',"where_value" => $input->username);
						$where2 = array ("where_column" => 'password',"where_value" => $input->password);
